...
processRouter.get("/process/get-processes", process, processController.getProcess);

processRouter.get("/process/get-process/:id", process, processController.getAProcess);
